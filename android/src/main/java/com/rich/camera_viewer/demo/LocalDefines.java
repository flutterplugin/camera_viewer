...
//	public static final String AD_PATH_PREFS = "AD_PATH_PREFS"; // Ad 存放的位置
	...
	public static boolean B_INTENT_ACTIVITY = false; //add by mai 2015-5-15 锟斤拷师锟角凤拷锟斤拷转锟斤拷锟斤拷锟?ctivity
...
//			long [] pattern = {500,1000,500,1000};   // 停止 锟斤拷锟斤拷 停止 锟斤拷锟斤拷   
	        vibrator.vibrate(pattern,-1);           //锟截革拷一锟斤拷锟斤拷锟斤拷锟?attern只锟截革拷一锟斤拷锟斤拷锟轿?-1
	       // vibrator.cancel();
		}
...
//  public static int APP_ID_V380=101120;
  ...
  static final int nBuildCount=11;//锟斤拷锟节憋拷识锟角凤拷锟揭伙拷锟斤拷锟斤拷锟?pp
